...
<div class="container">
	...
	<div class="row pl-0">
		<div class="col-md-8">
			<h2><?php echo $rows['Title']; ?> Album Here!</h2>
			<?php 
				$sql1 = "SELECT * FROM add_song WHERE Album_code = '$album'";
			...
			<table class="table">
			  ...
			  <tbody>
			    ...
			    <tr>
			      ...
			      <td>
			      	<a href="view-album.php?id=<?php echo $album ?>&song=<?php echo $rows1['Code']; ?>"><img width="50" src="img/play.png" alt=""></a>
			      </td>
			    </tr>
			    <?php 
			    	$i++;
