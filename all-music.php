			...
			<table class="table">
			  ...
			  <tbody>
			    ...
			    <tr>
			      ...
			      <td>
			      	<a href="all-music.php?song=<?php echo $rows1['Code']; ?>"><img width="30" src="img/play.png" alt=""></a>
			      </td>
			      <td>
			      	<?php 
			      		if($rows1['Favourite'] == 0){
			      			echo '<a href="add-fav-song.php?song='.$rows1['Code'].'"><img width="25" src="img/afav.png" alt=""></a>';
			      		}
			      		else{
			      			echo '<a href="remove-fav.php?song='.$rows1['Code'].'" ><img width="25" src="img/1.png" alt=""></a>';
			      		}
